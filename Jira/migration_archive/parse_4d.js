...
const listContent = fs.readFileSync('4D_Task_List_Testing_Advanced_Future_436_580.md', 'utf8');
const descContent = fs.readFileSync('4D_Task_Description_Testing_Advanced_Future_436_580.md', 'utf8');
...
fs.writeFileSync('tasks_4d.json', JSON.stringify(tasks, null, 2), 'utf8');
console.log('Wrote tasks_4d.json');
