          ...
          <main className="p-8 space-y-6 flex-1 overflow-y-auto max-w-[1366px] w-full mx-auto">
            <Card className="bg-white border border-hairline rounded-xl shadow-sm relative overflow-hidden">
              ...
              <CardHeader className="pl-8 pt-6">
                <CardTitle className="text-lg font-bold text-ink">Bán hàng tại quầy & Tương tác thuốc</CardTitle>
              </CardHeader>
              <CardContent className="pl-8 pb-8">
                <div className="flex flex-col items-center justify-center p-12 text-center space-y-4">
                  <span className="text-5xl">🛒</span>
                  <div>
                    <h3 className="font-bold text-ink text-lg">Màn hình bán hàng (POS)</h3>
                    <p className="text-sm text-graphite max-w-sm mt-1 leading-relaxed">
                      Màn hình POS, thanh toán hóa đơn và tự động kiểm tra cảnh báo tương tác thuốc thuộc các sprint sau. Hiện tại trang đang được thiết lập để giữ chỗ và phân quyền truy cập thành công.
                    </p>
                  </div>
                </div>
              </CardContent>
