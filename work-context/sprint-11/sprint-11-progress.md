...
|---|---|---:|---|---|---|---|---|
| US-151 | PAC-191 | 3 | PAC-TASK-526, PAC-TASK-527, PAC-TASK-530 | 2/3 | Pending | — | `story/PAC-191-us-151-admin-graph-sync-status-ui` |
...
Current Task = PAC-TASK-526 (Done)
Next technical Task = PAC-TASK-527 / PAC-737
```
