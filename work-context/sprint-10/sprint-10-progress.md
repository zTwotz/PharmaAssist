...
|---|---|
| Current phase | Prepared |
| Current Task | PAC-TASK-460 |
| Current Jira Key | PAC-670 |
| Current exact branch | `test/PAC-670-task-460-add-interactionalert-display-count-tests` |
| Current PR | Merged |
| Last merged Task | PAC-TASK-460 |
| Last merge SHA | 75bb2c2 |
| Next Task | PAC-TASK-461 |
| Next Jira Key | PAC-671 |
| Next exact branch | `test/PAC-671-task-461-add-high-alert-acknowledgement-tests` |
