...
|---|---|
| Current phase | Prepared |
| Current Task | PAC-TASK-466 |
| Current Jira Key | PAC-676 |
| Current exact branch | `test/PAC-676-task-466-add-fefo-allocation-unit-tests` |
| Current PR | Merged |
| Last merged Task | PAC-TASK-466 |
| Last merge SHA | 61dbcb7 |
| Next Task | PAC-TASK-467 |
| Next Jira Key | PAC-677 |
| Next exact branch | `test/PAC-677-task-467-add-fefo-multi-batch-allocation-tests` |
