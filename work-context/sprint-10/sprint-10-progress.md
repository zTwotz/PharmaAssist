...
|---|---|
| Current phase | Prepared |
| Current Task | PAC-TASK-453 |
| Current Jira Key | PAC-663 |
| Current exact branch | `test/PAC-663-task-453-add-pos-draft-order-api-tests` |
| Current PR | Merged |
| Last merged Task | PAC-TASK-453 |
| Last merge SHA | b32d6d3 |
| Next Task | PAC-TASK-454 |
| Next Jira Key | PAC-664 |
| Next exact branch | `test/PAC-664-task-454-add-pos-draft-order-ui-smoke-tests` |
