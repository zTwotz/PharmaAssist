...
| PAC-TASK-396 | PAC-606 | US-130 | Return Graph-RAG provenance metadata | `feature/PAC-606-task-396-return-graph-rag-provenance-metadata` | Technically complete | feat(graph-rag): PAC-606 return graph-rag provenance metadata | Yes | PENDING_MERGE | PASS | N/A | N/A | N/A | DONE |
