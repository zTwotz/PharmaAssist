...
| PAC-TASK-392 | PAC-602 | US-129 | Build allowlisted graph query templates | `feature/PAC-602-task-392-build-allowlisted-graph-query-templates` | Technically complete | feat(graph-rag): PAC-602 add allowlisted graph query templates | Yes | PENDING_MERGE | PASS | N/A | N/A | N/A | DONE |
