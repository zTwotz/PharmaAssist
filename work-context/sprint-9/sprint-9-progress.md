...
| PAC-TASK-397 | PAC-607 | US-130 | Return graphUsed flag in Graph-RAG response | `feature/PAC-607-task-397-return-graphused-flag-in-graph-rag-response` | Technically complete | feat(graph-rag): PAC-607 return graphUsed flag in graph-rag response | Yes | PENDING_MERGE | PASS | N/A | N/A | N/A | DONE |
