...
| PAC-TASK-395 | PAC-605 | US-129 | Add Graph-RAG context builder for AI Copilot | `feature/PAC-605-task-395-add-graph-rag-context-builder-for-ai-copilot` | Technically complete | feat(graph-rag): PAC-605 add graph-rag context builder | Yes | PENDING_MERGE | PASS | N/A | N/A | N/A | DONE |
